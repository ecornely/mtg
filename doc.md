...
| ☑️      | Saccage téméraire        | Forge Fires         |    ⚫, 🔴    | 
| ☑️      | Voie de la puissance     | Savage Scavengers   |    🔴, 🟢    | 
| ☑️      | Faim vampirique          | Vampiric Hunger     |    ⚪, ⚫    | 
| ☑️      | Machinations morbides    | Morbid Machinations |    ⚫, 🟢    | 
| ☑️      | Merveilleuse magie       | Arcane Marvels      |    🔵, 🔴    | 
| ☑️      | Puissance de la légion   | Legion's Might      |    ⚪, 🔴    | 
| ☑️      | Apprentissage terrestre  | Earthbound Learning |    🔵, 🟢    | 
| ☑️      | Cadeaux du cimetière     | Grave Matters       |    🔵, ⚫    | 
| ☑️      | Voltigeurs ésotériques   | Aerial Aeronauts    |    ⚪, 🔵    | 


## Dossier de donnée:
Dans mon install steam, on peut trouver une SQLite avec toutes les traductions dans le dossier:
`/home/corne/.local/share/Steam/steamapps/common/MTGA/MTGA_Data/Downloads/Raw`

## Interesting deck youtube playlist:
* [⚪ Cheap mono white with lock room](https://www.youtube.com/watch?v=yWaKvX5rYUs)
* [🔴⚫ Benefit from discard](https://www.youtube.com/watch?v=xl5EU19N6IA)


## Simic
4 Elfes de Llanowar (FDN) 227
4 Druidesse de l'Auvent (FDN) 554
2 Tatyova, druidesse benthique (FDN) 247
2 Mage d'exclusion (FDN) 508
2 Géant juré aux elfes (FDN) 103
2 Hydre née de la mousse (FDN) 107
1 Sphinx quantique (EOE) 72
1 Baloths déchaînés (FDN) 645
3 Étude rapide (FDN) 513
3 Attrait de Longue-Rivière (BLB) 58
2 Giration de sort (BLB) 72
2 Coup d'abattage (FDN) 105
4 Chutes de Boisépine (M21) 257
3 Porte de la guilde de Simic (FDN) 695
6 forêt (TMT) 319
4 Veine prometteuse (LCI) 279
4 Passage merveilleux (ELD) 244
3 Tunnel d'évasion (MKM) 261
4 île (TMT) 316
2 Harmonisateur puissaforme (EOE) 200
2 Carapace herbée féconde (BLB) 171

Améliorer la base de mana :

Les Portes de la guilde et les Chutes de Boisépine entrent engagées, ce qui te ralentit. Si tu as des jokers (wildcards), essaie d'intégrer des Côtes de la Mer de Chrome ou des Ligne de côte de skiff.

Renforcer le "Late Game" :
Baloths déchaînés est une excellente condition de victoire. En avoir un deuxième exemplaire à la place d'un Géant juré aux elfes rendrait le deck plus menaçant.

Protection :
Ton deck est très sensible aux anti-créatures de masse (Sweepers). Remplacer les 2 Giration de sort par des contre-sorts plus polyvalents comme Négation ou Intervention de Three Trees pourrait sauver tes grosses créatures.

Étude rapide ×3 — maintenant que tu as de la pioche via Tatyova et potentiellement la Carapace, payer 3 mana pour filtrer 2 cartes semble redondant. Je réduirais à ×1 voire ×0 et ajouterais une créature à la place.
Géant juré aux elfes ×2 — ses tokens 1/1 sont corrects avec les fetch lands mais comparé à Baloths qui fait des 4/4... c'est un peu pâle. C'est le candidat le plus faible du deck actuellement.
